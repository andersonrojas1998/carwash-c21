            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        <input disabled type="number" min="0" step="1" id="input_discount" name="descuento" class="form-control" placeholder="Descuento en $">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        <input disabled type="number" min="0" step="1" id="input_password_card" name="clave_vehiculo" class="form-control" placeholder="Clave">                        
                    </div>
                </div>
            </div>
